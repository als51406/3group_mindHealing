      ...
      <section style={{ marginBottom: 60 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          <FAQItem 
            ...
            answer="토닥톡은 AI 기반의 감정 분석 다이어리 서비스입니다. 일상의 감정을 기록하고, AI가 분석하여 인사이트를 제공합니다."
          />
          <FAQItem 
            question="다이어리는 어떻게 작성하나요?"
            answer="로그인 후 '다이어리' 메뉴에서 오늘의 감정과 일상을 자유롭게 작성하시면 됩니다. AI가 자동으로 감정을 분석합니다."
          />
          <FAQItem 
            question="챗온 기능은 무엇인가요?"
            answer="챗온은 다른 사용자들과 익명으로 감정을 공유하고 소통할 수 있는 커뮤니티 공간입니다."
          />
          <FAQItem 
            question="히스토리에서는 무엇을 볼 수 있나요?"
            answer="히스토리에서는 지난 감정 기록들을 달력과 차트로 확인할 수 있으며, 감정 패턴 분석과 추천을 받을 수 있습니다."
          />
          <FAQItem 
            question="목표 설정은 어떻게 하나요?"
            answer="'목표' 메뉴에서 개인적인 감정 관리 목표를 설정하고 진행 상황을 추적할 수 있습니다."
          />
        </div>
      </section>
